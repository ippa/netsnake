...
* Try to make the others run into you, last moving snake on screen wins
...
it will listen to 0.0.0.0 port 7778
...
A lot of lag will make it harder to play, but you should be able to compensate before you run into walls!
